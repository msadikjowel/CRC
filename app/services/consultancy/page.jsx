...
const services = [
  {
    ...
    text: "Practical strategic advice that helps organizations clarify priorities, strengthen decision-making, and move confidently toward their objectives.",
  },
  {
    icon: BriefcaseBusiness,
    title: "Project Design & Planning",
    text: "Supporting the development of structured projects and programs with clear objectives, logical frameworks, implementation strategies, and measurable results.",
  },
  {
    icon: Target,
    title: "Program Development",
    text: "Designing practical approaches that connect organizational priorities with the needs of communities, stakeholders, markets, and beneficiaries.",
  },
  {
    icon: TrendingUp,
    title: "Impact & Performance",
    text: "Helping organizations improve performance by connecting evidence, analysis, implementation, and measurable outcomes.",
  },
  {
    icon: Settings2,
    title: "Technical Assistance",
    text: "Providing specialized technical support to strengthen systems, processes, implementation capacity, and organizational effectiveness.",
  },
  {
    icon: Network,
    title: "Institutional Strengthening",
    text: "Supporting organizations in improving structures, systems, governance, processes, and internal capacities for sustainable performance.",
  },
];
...
const process = [
  {
    number: "01",
    title: "Understand",
    text: "We begin by understanding your objectives, operating environment, challenges, stakeholders, and priorities.",
  },
  {
    number: "02",
    title: "Analyze",
    text: "We examine available evidence, systems, risks, opportunities, and contextual factors to identify what matters most.",
  },
  {
    number: "03",
    title: "Design",
    text: "We translate insights into practical strategies, plans, systems, and solutions aligned with your objectives.",
  },
  {
    number: "04",
    title: "Deliver",
    text: "We support implementation with technical expertise, continuous learning, and recommendations focused on measurable results.",
  },
];
    ...
    <main className="bg-white overflow-hidden">
      ...
      <section className="relative min-h-[82vh] lg:min-h-[88vh] overflow-hidden bg-[var(--color-footer)]">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/consultancy/consultancy.jpeg')",
          }}
        />
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center w-full pt-28 pb-20">
            ...
            >
              ...
              <p className="mt-8 max-w-2xl text-base sm:text-lg lg:text-xl leading-relaxed text-white/65">
                Practical consultancy and technical expertise that help
                organizations navigate complex challenges, strengthen
                performance, and turn strategic priorities into meaningful
                results.
              </p>
              ...
              <div className="ml-auto max-w-sm">
                ...
                <div className="rounded-2xl border border-white/15 bg-white/5 backdrop-blur-md p-7">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-white/50">
                    We combine evidence, technical expertise, and contextual
                    understanding to provide consultancy that organizations
                    can act on.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] uppercase tracking-[0.25em] text-white/30">
                Strategy • Planning • Advisory • Transformation
              </span>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <span className="text-sm font-semibold tracking-[0.2em] uppercase text-[var(--color-secondary)]">
                Advisory that creates direction
              </span>
              ...
              <p className="mt-7 text-lg text-gray-600 leading-relaxed max-w-2xl">
                Organizations often face complex challenges that cannot be
                solved through isolated recommendations. Effective consultancy
                requires understanding the wider context, identifying the
                underlying issues, and developing solutions that are practical
                and achievable.
              </p>


              <p className="mt-5 text-gray-600 leading-relaxed max-w-2xl">
                CRC-BD works alongside organizations to translate evidence and
                expertise into clear strategies, stronger systems, practical
                plans, and actionable recommendations.
              </p>
              ...
              <div className="relative rounded-3xl bg-gray-50 border border-gray-200 p-7 sm:p-9">
                ...
                <div className="relative">
                  ...
                  <p className="mt-4 text-gray-600 leading-relaxed">
                    Our consultancy approach is grounded in research,
                    contextual analysis, professional expertise, and a clear
                    understanding of organizational realities.
                  </p>
                  ...
                  <div className="mt-7 pt-6 border-t border-gray-200">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-700">
                        Practical solutions, not just recommendations
                      </span>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            <p className="mt-5 text-lg text-gray-600 leading-relaxed">
              Our multidisciplinary expertise allows us to provide tailored
              advisory and technical support across research, development,
              humanitarian, institutional, and private-sector contexts.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            <p className="mt-6 text-lg text-white/55 leading-relaxed">
              We believe effective consultancy begins with listening and
              understanding before moving toward strategy, recommendations,
              and implementation.
            </p>
          ...
          <div className="grid lg:grid-cols-12 gap-14 items-start">
            ...
            >
              ...
              <p className="mt-6 text-gray-600 leading-relaxed">
                CRC-BD combines multidisciplinary knowledge with evidence and
                contextual understanding to provide consultancy services that
                are relevant, practical, and results-oriented.
              </p>
            ...
            <div className="relative z-10 grid lg:grid-cols-12 gap-10 items-end">
              ...
              <div className="lg:col-span-8">
                ...
                <p className="mt-6 max-w-2xl text-lg text-white/60 leading-relaxed">
                  Tell us about your objectives and challenges. Our team can
                  help identify practical research, consultancy, technical, or
                  advisory solutions tailored to your needs.
                </p>
